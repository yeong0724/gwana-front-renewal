  ...
  useIsomorphicLayoutEffect(() => {
    ...
    mm.add(
      ...
      (context) => {
        ...
        const splits = [bodyRef.current, statOneRef.current, statTwoRef.current].map((el) =>
        ...
        if (!isDesktop) {
          ...
          gsap
            ...
            .to(statTwoSplit.lines, { duration: 0.6, stagger: 0.2, yPercent: 0 }, '<+=0.5');
          return cleanup;
        }
  ...
  return (
    <section
      ...
      className={cn(
         ...
         */
        'relative overflow-hidden border-t border-b',
        'lg:h-[600vh]',
        BG.page,
        BORDER.line,
